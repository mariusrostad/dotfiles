...
Codex reads this file when generating an interactive HTML spec preview. Follow the template structure exactly, replacing `{{PLACEHOLDER}}` markers with interview content.
...
Codex MUST use this exact structure. Replace `{{PLACEHOLDER}}` markers with generated content.
...
<body>
  ...
  <script>
    ...
    function revise() {
      ...
      copyToClipboard(feedback, 'Comments copied! Paste in Codex to revise.');
    }

    function approve() {
      copyToClipboard(
        'All sections approved — generate final spec.',
        '"Approved" copied! Paste in Codex.'
      );
    }
...
Codex maps interview content to sections as follows:
